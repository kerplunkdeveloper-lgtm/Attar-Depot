        ...
        <div className="p-5 sm:p-6 border-b border-slate-200/80 bg-slate-50/80 flex flex-col sm:flex-row sm:items-center justify-between gap-4 transition-colors">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1">
              Active patrons and real-time transaction profiles from database
            </p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-200/80 pb-5">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="hidden sm:inline-flex items-center gap-1 text-[11px] font-bold px-2.5 py-0.5 rounded-full bg-emerald-50 text-emerald-800 border border-emerald-200 shadow-xs">
                <Radio className="w-3 h-3 text-emerald-600 animate-pulse" />
                Live Telemetry
              </span>
            </div>
            <p className="text-xs text-slate-500 mt-1">
              Interactive visualization of patron acquisition, revenue volume, and retention tiers
            </p>
          </div>
