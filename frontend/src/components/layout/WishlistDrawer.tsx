        ...
        <div className="fixed inset-0 z-[95] overflow-hidden">
          ...
          <div className="fixed inset-y-0 right-0 max-w-full flex pl-10 pointer-events-none">
            <motion.div
              ...
              animate="visible"
              exit="exit"
              className="w-screen max-w-md bg-white border-l border-[#C9A227]/30 shadow-2xl flex flex-col pointer-events-auto"
            >
                          ...
                          <div className="flex-1 min-w-0 flex flex-col justify-between">
                            ...
                            <div className="flex items-center gap-2 pt-2.5 mt-1 border-t border-stone-200/60 font-sans">
                              <motion.button
                                ...
                                className="flex-1 py-1.5 px-3 bg-stone-900 text-[#FAF6F0] hover:bg-emerald-950 text-[11px] font-bold uppercase tracking-wider transition-all duration-200 flex items-center justify-center gap-1.5 shadow-2xs"
                              >
              ...
              {items.length > 0 && (
                <div className="p-4 sm:p-5 bg-white border-t border-stone-200 space-y-3 font-sans">
                  <motion.button
                    ...
                    className="w-full py-3.5 px-4 bg-gradient-to-r from-[#012520] via-[#023830] to-[#012520] text-[#FAF8F2] hover:brightness-110 border border-[#C9A227]/40 text-xs font-bold uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-2 shadow-lg"
                  >
