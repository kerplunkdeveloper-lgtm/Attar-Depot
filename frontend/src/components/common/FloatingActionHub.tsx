...
import { popSpring, luxuryEase } from '@/lib/animations';
    ...
    <div className="fixed bottom-20 right-4 sm:bottom-6 sm:right-6 z-40 flex flex-col items-end gap-3 pointer-events-none">
      ...
      >
        <motion.a
          ...
          className="flex items-center justify-center w-12 h-12 sm:w-13 sm:h-13 rounded-full bg-[#25D366] text-white shadow-lg hover:shadow-xl transition-shadow focus:outline-none focus:ring-2 focus:ring-[#25D366]/40"
        ...
        {showBackToTop && (
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              onClick={scrollToTop}
              className="flex items-center justify-center w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-white/95 text-emerald-800 border border-emerald-200/80 shadow-md hover:shadow-lg hover:bg-emerald-50 transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-500/30 backdrop-blur-xs"
